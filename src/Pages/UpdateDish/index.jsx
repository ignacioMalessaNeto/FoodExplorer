...
export function UpdateDish() {
    ...
    async function handleUpdateDish() {
        try {
            ...
            navigate(-1);
            return alert("Prato atualizada com sucesso!")
        } catch (error) {
            console.log(error);
    ...
    async function handleDeleteDish() {
        ...
        if (confirm) {
            try {
                ...
                navigate(-1);
                return alert("Prato excluído com sucesso!")
            } catch (error) {
                console.log(error);
    ...
    return (
        <Container>
            ...
            <main>
                <ImageDish>
                    <label htmlFor="opcoes">Imagem do prato</label>
